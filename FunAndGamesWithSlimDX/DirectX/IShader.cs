...
namespace DungeonHack.DirectX
{
    public interface IShader
    {
        ...
        void UpdateLightsFrameConstantBuffers(DirectionalLight[] directionalLight, PointLight[] pointLight, Spotlight[] spotLight);
        void UpdateFrameConstantBuffers(Camera camera);
    }
}