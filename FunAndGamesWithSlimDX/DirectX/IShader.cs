...
namespace FunAndGamesWithSharpDX.DirectX
{
    public interface IShader
    {
        ...
        void Render(DeviceContext context, int indexCount, Matrix worldMatrix, Matrix viewProjectionMatrix, ShaderResourceView texture, Vector3 cameraPosition, Material material);
