...
namespace DungeonHack.DirectX
{
    public class DeferredShader : IShader
    {
        ...
        public void Initialize()
        {
            ...
            var vsShaderName = basePath + @"\Shaders\DeferredVS.hlsl";
            var psShaderName = basePath + @"\Shaders\DeferredPS.hlsl";
            var hsShaderName = basePath + @"\Shaders\DeferredHS.hlsl";
            var dsShaderName = basePath + @"\Shaders\DeferredDS.hlsl";
